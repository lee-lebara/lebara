...
<div class="landingpage_subnav">
	...
	<div class="fake_page_content_ukplus">
            ...
            <a href="payment_details_cc_loggedin.php" class="fake_buynow_button"  style="margin: 10px 0px 0px 0px; padding: 14px 7px; width: 150px; height: 20px; background-color: #d1005d; border: 0px; border-radius: 7px; color: #ffffff; font-size: 1.2em; font-family: GothamBook; text-align:center; text-decoration: none;">BUY NOW</a>
<div class="clear"></div>
     </div> 
