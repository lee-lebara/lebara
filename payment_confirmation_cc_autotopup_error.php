...
<div class="content_box mobile_element">
    ...
    <div class="special_promotion"><a href="promotion_1_loggedin.php"><img src="images/special_promotion_1.jpg"
                                                                           alt="Special Promotion One"/></a></div>
    <div class="special_promotion promo_last"><a href="promotion_1_loggedin.php"><img
                src="images/special_promotion_2.jpg" alt="Special Promotion Two"/></a></div>
    <div class="clear"></div>
</div>
...
<div class="purchase_page_container desktop_element">
    ...
    <div class="payment_container">
        <div class="section-2">
            <h2 class="success_message" style="float: left; font-size: 3em;">Your Purchase Is Complete</h2>

            <div class="clear"></div>
            <div class="blue_information_box">
                <h4 style="font-family: GothamBook;">&pound;10 has been added to your account, PLUS a free credit
                    of &pound;2.50</h4>

                <div class="clear"></div>
            </div>
            <p class="psp_para">Your order number is xxxxxx, if you experience any problems contact <a
                    href="contact_us.php">customer services here</a>.</p>

            <div class="sms-code-container">

                <h4>Your MyLebara Account has been created.</h4>

                <p>You will receive an SMS verification code to activate your MyLebara account. Please input it
                    here:</p>

                <div class="clear"></div>

                <div class="narrow_details_field" style="width: 75%">
                    ...
                    <div class="narrow_input_field" style="margin-top: 3px;">
                        ...
                        <div class="validate-message">
                            <p id="mf128">Incorrect SMS code. Please check and try again.</p>
                        </div>
            ...
            <div class="confirmation_upsells">
                ...
                <a href="uk_plus.php" class="upsell_1">
                    ...
                    <p>Call friends in UK, browse internet and get discounts on international calls for just <span>&pound;7.95</span>
                    </p>
                </a>
                <a href="data_passes.php" class="upsell_2">
                    ...
                    <p>Stay connected on the go with our great value Mobile Internet passes - <span>10MB, 500MB</span>
                        and <span>1GB</span></p>
                </a>
            </div>
    ...
    <a id="customer_popup_trigger_prod" class="purchase_options_container_continue" href="index.php"
       style="padding-right: 80px; width: 158px;">FINISH</a>
