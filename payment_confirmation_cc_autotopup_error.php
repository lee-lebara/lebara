...
<div class="payment_container">
 <div class="section-2">
    						...
    						<span>*SMS Code</span><div class="narrow_input_field" style="margin-top: 3px;">

    						<input type="tel" name="sms_verify" value="" />

    						</div>

    						<div id="verified" style="display: none;"><img src="./images/small_green_tick.gif" alt="Verified"></div>

                            <div id="incorrect" style="display: block;"><img src="./images/incorrect.gif" alt="Verified"></div>
