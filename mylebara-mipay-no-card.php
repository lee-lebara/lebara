...
<div class="desktop_page_container mipay-option-validate">
    ...
    <!--    Include this for mipay validation -->
    ...
    <div class="mylebara_page_header">
        <h2 class="mylebara_header">Hi John</h2>

        <div class="last_login_details">Last login: 12 Jun-2013</div>
    </div>
    ...
    <div class="mylebara_summary_panel">
        ...
        <ul>
            ...
            <li><a href="#"><img src="./images/mylebara_icon_password.gif"
                                 alt="Change Password"><span>Change Password</span></a></li>
        </ul>
    </div>
    ...
    <div class="mylebara_primary_content">
        ...
        <div class="mylebara_content_box">
            <table class="mylebara_table" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>Unlimited L2L Mins</td>
                    <td>Currently set to <a class="set_or_not" style="display: none;">NOT </a>Unlimited</td>
                    <td>2013-07-13</td>
                </tr>
                <tr class="odd">
                    <td>Unlimited L2L SMS</td>
