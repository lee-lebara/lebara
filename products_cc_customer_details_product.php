...
<p>Please input your name and email address:</p>
    ...
    <div class="tandcs_checkbox"><input type="checkbox" name="customer_communications" value="true"> Tick box if you would prefer not to receive email communications and offers from Lebara Mobile.</div>
    <div class="clear"></div>
   
</div>

<div class="payment_container_bottom"></div><a id="customer_popup_trigger_prod" class="purchase_options_container_continue" href="payment_details_cc.php">CONTINUE</a>
