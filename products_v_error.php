...
<div class="content_box_invisible">
	<div class="voucher_error_message"><img src="./images/number_alert.gif" alt="alert" />The mobile number you entered was not recognised.</div>
</div>
<div class="content_box">
	<h2>Enter mobile number</h2>
    <p class="margin_bottom">Please enter the mobile number you would like to top up.</p>
	<div class="default_input_field error_border"><input type="tel" name="mobile_number" value="" /></div>
</div>
...
<div class="content_box_invisible">
	<div class="wide_button blue"><a href="payment_details.php"><span>CONTINUE TO NEXT STEP</span></a></div>
