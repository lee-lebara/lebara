...
<p>Please input your name and email address:</p>
    ...
    <div class="clear"></div>
    <div class="narrow_details_field"><span>*Create a password:</span><div class="narrow_input_field"><input type="password" name="password" /></div></div>
    <div class="narrow_details_field"><span>*Repeat password:</span><div class="narrow_input_field"><input type="password" name="repeat_password" /></div></div>
    <p class="psp_para">By creating a password, you will be able to access MyLebara which will help you keep track of your purchases and top up quickly and easily. We keep your details securely on file, and never share this information with anyone. </p>
    <p class="psp_para">* This information is mandatory</p>
    <p class="psp_para"><strong>Note:</strong> We only require your email address for the confirmation that we send. We will never contact you without your permission, or give your details to anyone else.</p>
    <div class="tandcs_checkbox"><input type="checkbox" name="tandcs" value="true"> I agree with the <a href="terms_and_conditions.php" target="_blank">terms and conditions.</a></div>
    
<div class="clear"></div>
</div>

<div class="payment_container_bottom"></div><a id="customer_popup_trigger_prod" class="purchase_options_container_continue" href="payment_details_cc_addregistration.php">CONTINUE</a>
