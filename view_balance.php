...
<div class="content_box">
    ...
    <div style="float: right; width: 62%; font-size: 0.8em;">
    	<h4 style="font-size: 1.2em; color: #00a6eb; font-family: GothamBold; margin-bottom: 5px;">Pay As You Go</h4>
        <h5 style="float: left; font-family: GothamMedium; font-size: 1.1em; margin: 3px 10px 0px 0px;">Auto Top Up:</h5>
    	<div style="float: left;">Top Up with 
        	<select>
        ...
        <div class="cb-bg_small" style="margin: 0px;">
    			<a class="auto_topup_switch"><div class="cb-slider_small" cb-status="0"></div></a>
			</div>
    </div>
    <div class="clear"></div>
        
    
     <div style="float: right; width: 62%; font-size: 0.8em; margin-top: 20px;">
    	<h4 style="font-size: 1.2em; color: #00a6eb; font-family: GothamBold; margin-bottom: 5px;">Unlimited 29</h4>
        <h5 style="float: left; font-family: GothamMedium; font-size: 1.1em; margin: 3px 10px 0px 0px;">Auto Renew:</h5>
    	<div style="float: left; width: 65%;"> If you activate Auto Renew, it will be take effect when your current pass expires on 30/06/2013</div>
        <div class="cb-bg_small" style="margin: 0px;">
    			<a class="auto_topup_switch"><div class="cb-slider_small" cb-status="0"></div></a>
			</div>
    </div>
...
<div class="content_box_invisible">
	...
	<div class="wide_button rubine"><a class="sub_buttons"><span>TOP UP</span></a></div>
    	...
    	<div class="narrow_button rubine"><a href="products_cc_loggedin.php"><span>BUY NOW</span></a></div>
    	<div class="narrow_button orange last"><a href="products_v_loggedin.php"><span>USE VOUCHER</span></a></div>
    </div>
