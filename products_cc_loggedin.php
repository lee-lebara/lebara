...
<script>
function autoTopUp(){
    window.location="products_cc_add_extras_loggedin.php";
}
</script>
...
<!--<div class="topup_rates_box">
	<h2>Find Rates</h2>
    <p>Type in your country to find the standard Lebara Pay As You Go rates:</p>
    <p><div class="narrow_input_field"><input type="text" name="country" id="country" value="" placeholder="Algeria" /></div></p>
</div>-->
