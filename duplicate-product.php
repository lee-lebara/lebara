...
<div class="universal-error-page">
 	<h1>Oops Duplicate Product!</h1>
    <p>Looks like you have purchased this product already!</p>

    <p><a href="#" onclick="history.back(-1)" >Click here to go back and choose another</a></p>
