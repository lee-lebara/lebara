...
<div class="payment_container">
 <div class="section-2">
                            <h2 class="success_message" style="float: left; font-size: 3em;">Thank You for your Top Up!</h2>
                            <div class="clear"></div>
                            ...
                            <p>You will receive an SMS verification code to activate your MyLebara account. Please input it here:</p>
                            <div class="clear"></div>
                            
    						<div class="narrow_details_field" style="width: 75%"><span>*SMS Code</span><div class="narrow_input_field" style="margin-top: 3px;"><input type="tel" name="sms_verify" value="" /></div><div id="verified" style="display: none;"><img src="./images/small_green_tick.gif" alt="Verified"></div>
    <a class="sms_verification_button" onClick="toggle_visibility('verified');">APPLY</a></div>
                            <div class="clear"></div>
                            ...
                            <h3 style="margin-top: 50px; font-family: GothamBold; color: #00a6eb; font-size: 1.3em;">Your MyLebara Account has been created.</h3>
 							<p class="psp_para">We've sent an email to the address you gave us - please click the link in the email to confirm your details.</p>	
