...
<div class="payment_container_bottom"></div><a id="customer_popup_trigger_prod" class="purchase_options_container_continue" style="padding: 40px 33px 0px 32px;" href="free_sim_confirmation_loggedin.php">GET MY FREE SIM</a>
</div>
