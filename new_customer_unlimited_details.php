                ...
                <form name="step01" id="step01" >
                        ...
                        <div class="section-2">
                            ...
                            <div class="customer_details">
                                ...
                                <div class="narrow_details_field"><span>*Title:</span>
    								...
    								<div class="narrow_details_field"><span>*Name</span><div class="psp_input_field"><input type="text" name="first_name" value="" /></div></div>
    								<div class="narrow_details_field"><span>*Last Name</span><div class="psp_input_field"><input type="text" name="last_name" value="" /></div></div>
    								<div class="narrow_details_field"><span>*Email</span><div class="psp_input_field"><input type="text" name="email" value="" /></div></div>
    								<div class="narrow_details_field"><span>*Repeat Email</span><div class="psp_input_field"><input type="text" name="email_repeat" value="" /></div></div>
    								<div class="narrow_details_field"><span>*Password</span><div class="psp_input_field"><input type="text" name="password" value="" /></div></div>
    								<div class="narrow_details_field"><span>*Repeat Password</span><div class="psp_input_field"><input type="text" name="password_repeat" value="" /></div></div>
                                    
                            </div>
                            <div class="customer_details">
									<div class="narrow_details_field"><span>*First line of address</span><div class="psp_input_field"><input type="text" name="address_1" id="address_1" value="" placeholder="e.g. 28" /></div></div>
    								<div class="narrow_details_field"><span>*Postcode</span><div class="psp_input_field"><input type="text" name="postcode" id="postcode" value="" placeholder="eg AL9 6BL" /></div></div>
    								<div class="lookup_button blue" style="width: 100px;"><a class="auto_address_button" ><span>LOOK UP</span></a></div>
    								...
    								<div class="manual_fields" id="toggleText2" style="display: none;">
    									<div class="narrow_details_field"><span>*Street</span><div class="psp_input_field"><input type="text" name="street" value="" /></div></div>
    									<div class="narrow_details_field"><span>*Town/City</span><div class="psp_input_field"><input type="text" name="town_city" value="" /></div></div>
    								</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="clear"></div>
                        ...
                        <div class="continue_button_container">
                            <button type="button" class="ui-btn-primary btn-continue"  onClick="parent.location='new_customer_unlimited_payment.php'" >Continue to payment</button>
                        </div>
