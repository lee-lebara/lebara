...
<div class="content_box">
    ...
    <p>You have selected product x at &pound;xx.xx</p>
    ...
    <div class="narrow_details_field"><span>Card Number</span><div class="narrow_input_field_error"><input type="tel" name="card_number" value="" /></div></div>
    <div class="payment_error_message">CARD NUMBER ERROR MESSAGE</div>
	<div class="narrow_details_field"><span>Expiry Date</span>
    	<div class="month_dropdown">
    		<select class="dropdown_error">
    ...
    <div class="payment_error_message">EXPIRY DATE ERROR MESSAGE</div>
    <div class="narrow_details_field"><span>Security Code</span>
    	<div class="security_code_field_error"><input type="text" pattern="[0-9]*" name="card_number" value="" /></div>
        <div class="payment_error_message">SECURITY CODE ERROR MESSAGE</div>
    ...
    <div class="narrow_details_field"><span>First line of address</span><div class="narrow_input_field_error"><input type="text" name="address_1" value="" /></div></div>
    <div class="payment_error_message">ADDRESS ERROR MESSAGE</div>
    <div class="narrow_details_field"><span>Postcode</span><div class="narrow_input_field_error"><input type="text" name="postcode" value="" /></div></div>
    <div class="payment_error_message">POSTCODE ERROR MESSAGE</div>
    ...
    <div class="payment_error_message">T&AMP;CS ERROR MESSAGE</div>
