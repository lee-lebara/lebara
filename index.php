...
<div class="mobile_element"><?php include($DOCUMENT_ROOT . "./includes/homepage_hero.php"); ?></div>

<?php include($DOCUMENT_ROOT . "./includes/homepage_hero_desktop_new.php"); ?>


<h1 class="mobile_element">Welcome</h1>

<?php include($DOCUMENT_ROOT . "./includes/homepage_buttons.php"); ?>
...
<a href="free_sim.php" class="feature_module_link"><img src="images/feature_module_button_sim.gif" alt="Get your SIM"></a>
</div>
...
<div class="top_up_credit_copy_tablet">add <span>&pound;20</span> get an extra <span>&pound;10</span> FREE</div>
<div class="top_up_credit_copy_desktop">add<br><span>&pound;20</span><br>get an extra<br><span>&pound;10</span><br>FREE</div>
<div class="clear"></div>
</div>
<a href="products_cc.php" class="feature_module_link"><img src="images/feature_module_button_topup.gif" alt="Top Up Now"></a>
</div>
...
<a href="blackberry_pass.php" class="feature_module_link"><img src="images/feature_module_button_findoutmore.gif" alt="Find Out More"></a>
</div>
