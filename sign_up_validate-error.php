...
<h1 class="desktop_element product_header">Sign up for <span>MyLebara</span></h1>
...
<p>Please input your name and email address:</p>
    ...
    <p class="psp_para">By creating a password, you will be able to access MyLebara quickly and easily. We keep your details securely on file, and never share this information with anyone. </p>
...
<div class="payment_container_bottom"></div><a id="customer_popup_trigger_prod" class="purchase_options_container_continue" href="sign_up_confirmation.php">CONTINUE</a>
