...
<?php $pageTitle = "Log In to Lebara";
...
<?php include($DOCUMENT_ROOT . "./includes/login_header.php"); ?>

<?php include($DOCUMENT_ROOT . "./includes/login_details_validation_error.php"); ?>
