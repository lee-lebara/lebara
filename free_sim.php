...
<h1 class="desktop_element product_header">Get your <span>FREE SIM</span> to join Lebara</h1>
...
<!--<div class="purchase_nav_container">
	<ol class="purchase_nav_ml_threestep">
        ...
        <li class="purchase_step_2">2. Payment Details</li>
        <li class="purchase_step_3">3. Confirmation Page</li>
    </ol>
</div>-->
...
<div class="payment_container">
    ...
    <div class="narrow_details_field"><span>*Last Name</span><div class="narrow_input_field"><input type="text" name="last_name" value="" /></div></div>
    <div class="narrow_details_field"><span>*Email</span><div class="narrow_input_field"><input type="text" name="email" value="" /></div></div>
	<div class="narrow_details_field"><span>*First line of address</span><div class="narrow_input_field"><input type="text" name="address_1" id="address_1_2" value="" placeholder="e.g. 28" /></div></div>
    <div class="narrow_details_field"><span>*Postcode</span><div class="narrow_input_field"><input type="text" name="postcode" id="postcode_2" value="" placeholder="eg AL9 6BL" /></div></div>
...
<div class="payment_container_bottom"></div><a id="customer_popup_trigger_prod" class="purchase_options_container_continue" style="padding: 40px 33px 0px 32px;" href="free_sim_confirmation.php">GET MY FREE SIM</a>
</div>
