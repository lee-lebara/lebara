...
<h2>My Lebara Sign Up</h2>
<h3>Thank You!</h3>
	<p>You've now signed-up for MyLebara. Note that we've sent you an email to confirm your identity and protect your information and SIM from fraudulent use.</p>
	<p class="bolder_paragraph">Please click on the link in the email to ensure you will be able to log in to MyLebara in future.</p>
	<p>*If you don't receive the email remember to check your junk or spam folder.</p>
    <div class="clear"></div>
</div>
