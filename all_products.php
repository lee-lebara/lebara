...
<div class="desktop_page_container mobile_element">
  ...
  <script type="text/javascript">
            ...
            $(document).ready(function()
            {
				...
				$('#loading5').addClass('hide');
                $('#wrong5').addClass('hide');
                $('#promo-error-text5').addClass('hide');
				$('#loading6').addClass('hide');
                $('#wrong6').addClass('hide');
                $('#promo-error-text6').addClass('hide');
				...
				if($('.ui-checkBx5').length > 1)
                {
                    $('div.ui-checkBx5').unbind('click').bind('click', function(e)
                    {
                        if($('div.ui-checkBx5').hasClass('auto-topup-off'))
                        {
                            $('div.ui-checkBx5').addClass('auto-topup-on').removeClass('auto-topup-off');
                            $('input.ui-checkBx5').val('ON');
                        }
                        else
                        {
                            $('div.ui-checkBx5').addClass('auto-topup-off').removeClass('auto-topup-on')
                            $('input.ui-checkBx5').val('OFF');
                        }
                ...
                $('.remove-auto-renew').unbind('click').bind('click', function(e)
                {
                    $('div.ui-checkBx5').trigger('click');
                });
				
				
				
				if($('.ui-checkBx6').length > 1)
                {
                    $('div.ui-checkBx6').unbind('click').bind('click', function(e)
                    {
                        if($('div.ui-checkBx6').hasClass('auto-topup-off'))
                        {
                            $('div.ui-checkBx6').addClass('auto-topup-on').removeClass('auto-topup-off');
                            $('input.ui-checkBx6').val('ON');
                        }
                        else
                        {
                            $('div.ui-checkBx6').addClass('auto-topup-off').removeClass('auto-topup-on')
                            $('input.ui-checkBx6').val('OFF');
                        }
...
<div id="wrapper" class="desktop_element">
			...
			<div class="purchase_balance_box">
                ...
                <form name="step01_ap" id="step01_ap" style="margin-left: 80px;" >
                    <div class="form-elements">
                        ...
                        <div class="product_divider"></div>
                        <div class="section-3">
                            <h3 class="unlimited-header">Passes<span class="unlimited-more-info"> Calls, Texts, Data...</span></h3>
                            <div id="select-product" class="error-message-holder"></div>
                            <fieldset class="sim-topup-detail">
                                <div class="sim-topup-amount-detail radiobtn-group">
                                    <label>Select the amount to Top Up</label>
                        ...
                        <div class="product_divider"></div>
                        <div class="section-3">
                            <h3 class="unlimited-header">Internet<span class="unlimited-more-info"> Great value bundles for internet on the go.</span></h3>
                            <div id="select-product" class="error-message-holder"></div>
                            <fieldset class="sim-topup-detail">
                                <div class="sim-topup-amount-detail radiobtn-group">
                                    <label>Select the product you need</label>
                                    <a href="#" id="internet_025" class="sim-topup-amount" onClick="onSelectProductClickEvent(this, 'a','b','c')" ><span>&pound;0.25</span></a>
                                    <a href="#" id="internet_5" class="sim-topup-amount" onClick="onSelectProductClickEvent(this, 'a','b','c')" ><span>&pound;5.00</span></a>
                                    <a href="#" id="internet_10" class="sim-topup-amount" onClick="onSelectProductClickEvent(this, 'a','b','c')" ><span>&pound;10.00</span></a>
                                    <input type="hidden" id="productCode" value="" />
                                    <input type="hidden" id="productFormatedPrice" value="" />
                                    <input type="hidden" id="newProduct" value="" />
                                    <input type="hidden" id="esbProductId" value="" />
                        ...
                        <div class="product_divider"></div>
                        <div class="section-3">
                            <h3 class="unlimited-header">UK Plus<span class="unlimited-more-info"> Special discount bundle for one great price.</span></h3>
                            <div id="select-product" class="error-message-holder"></div>
                            <fieldset class="sim-topup-detail">
                                <div class="sim-topup-amount-detail radiobtn-group">
                                    <label>Select the product you need</label>
                                    <a href="#" id="ukplus_795" class="sim-topup-amount" onClick="onSelectProductClickEvent(this, 'a')" ><span>&pound;7.95</span></a>
                                    <input type="hidden" id="productCode" value="" />
                                    <input type="hidden" id="productFormatedPrice" value="" />
                                    <input type="hidden" id="newProduct" value="" />
                                    <input type="hidden" id="esbProductId" value="" />
                                ...
                                <div class="auto-renew-detail">
                                    <label class="auto-renew-lbl">Select Auto Renew</label>
                                    <input type="hidden" id="auto-renew5" class="ui-checkBx5" value="OFF" />
                                    <div class="auto-topup auto-topup-off ui-checkBx5"></div>
                                    <div class="auto-renew-cnt">
                                        It will renew automatically every 30 days from the day of purchase.
                                    </div>
                                    <span class="more-info">More info and Terms &amp; Conditions <a href="#" class="">here</a></span>
                                ...
                                <div class="promo-code">
                                        ...
                                        <div class="promo-code-input" >
                                            <input type="text" name="promo-code" id="promo-code" />
                                            <span id="promo-error-text5" class="promo-error-txt5">Wrong code</span>
                                        </div>
                                        <button class="ui-btn-secondary btn-apply" >
                                            Apply
                                        </button>
                                        <div class="promo-code-img">
                                            <img id="loading5" src="images/icons/loading.gif" class="" />
                                            <img id="wrong5" src="images/simPurchase/wrong.jpg" style="margin-top: 4px; margin-left: 2px;" class="" />
                                        </div>
                                    </div>
                            </fieldset>
                        </div>
                        ...
                        <div class="product_divider"></div>
                        <div class="section-3">
                            <h3 class="unlimited-header">Passes for Blackberry<span class="unlimited-more-info"> Monthly Internet Access for Blackberry</span></h3>
                            <div id="select-product" class="error-message-holder"></div>
                            <fieldset class="sim-topup-detail">
                                <div class="sim-topup-amount-detail radiobtn-group">
                                    <label>Select the product you need</label>
                                    <a href="#" id="blackberry_5" class="sim-topup-amount" onClick="onSelectProductClickEvent(this, 'a')" ><span>&pound;5.00</span></a>
                                    <input type="hidden" id="productCode" value="" />
                                    <input type="hidden" id="productFormatedPrice" value="" />
                                    <input type="hidden" id="newProduct" value="" />
                                    <input type="hidden" id="esbProductId" value="" />
                                ...
                                <div class="auto-renew-detail">
                                    <label class="auto-renew-lbl">Select Auto Renew</label>
                                    <input type="hidden" id="auto-renew6" class="ui-checkBx6" value="OFF" />
                                    <div class="auto-topup auto-topup-off ui-checkBx6"></div>
                                    <div class="auto-renew-cnt">
                                        It will renew automatically every 30 days from the day of purchase.
                                    </div>
                                    <span class="more-info">More info and Terms &amp; Conditions <a href="#" class="">here</a></span>
                                ...
                                <div class="promo-code">
                                        ...
                                        <div class="promo-code-input" >
                                            <input type="text" name="promo-code" id="promo-code" />
                                            <span id="promo-error-text6" class="promo-error-txt6">Wrong code</span>
                                        </div>
                                        <button class="ui-btn-secondary btn-apply" >
                                            Apply
                                        </button>
                                        <div class="promo-code-img">
                                            <img id="loading6" src="images/icons/loading.gif" class="" />
                                            <img id="wrong6" src="images/simPurchase/wrong.jpg" style="margin-top: 4px; margin-left: 2px;" class="" />
                                        </div>
                                    </div>
                            </fieldset>
                        </div>
    ...
    <div id="customer_popup_prod">
    	...
    	<div class="selection_box">
            ...
            <h4 class="blue">Do you have a Lebara SIM? <a class="customer_popupClose_prod">x</a></h4>
            ...
            <h4 class="blue">Please enter your details to continue: <a class="customer_popupClose_prod">x</a></h4>
             ...
             <div class="signin_details" id="toggleText33_prod" style="display: none;">
             			...
             			<h4 class="blue">Please enter your Lebara Mobile Number: <a class="customer_popupClose_prod">x</a></h4>
