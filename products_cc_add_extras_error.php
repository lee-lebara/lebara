...
<script>
function autoTopUp(){
    if( document.getElementById("box").checked==true || document.getElementById("box2").checked==true || document.getElementById("box3").checked==true )
	{
...
<h3>Your Products</h3>
	...
	<div class="product_summary_promo_box">Have a promo code? You can enter it here: <input type="text" name="promo_code" class="promo_field_error" /><div id="verified" style="display: none;"><img src="./images/small_green_tick.gif" alt="Verified"></div>
		<a onClick="toggle_visibility('verified');">APPLY</a>
        <div class="promo_error_text">Sorry, that code is invalid. Please try again.</div>
	</div>
