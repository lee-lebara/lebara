             ...
             <div class="signin_details">
                        ...
                        <!--  Error message snippet -->
                            <div class="validate-message">
                                <h1>This mobile number is already registered. <a href="login.php">Please click here to login</a></h1>
                            </div>

                    		<div class="signin_content2">
                    			<div class="signin_input_field2 validate-error"><input type="tel" name="mobile_number" id="mobile_number" value="" placeholder="Lebara Mobile Number" style="margin-bottom: 0px;" ></div>
                                <div class="signin_input_field2 validate-error"><input type="tel" name="mobile_number" id="mobile_number_verify" value="" placeholder="Verify Lebara Mobile Number" style="margin-top: 0px;" ></div>
                        	</div>
                            <div class="clear"></div>
