...
<div class="purchase_nav_container">
	<ol class="purchase_nav_ml_threestep">
        ...
        <li class="purchase_step_3 active_step">3. Payment Method</li>
...
<h3>Input the security code for your card:</h3>
    ...
    <div class="tandcs_checkbox" style="margin-left: 30px;"><input type="checkbox" name="tandcs" value="true"> I agree with the <a href="terms_and_conditions.php" target="_blank">terms and conditions.</a></div>
    <p><a href="choose_cc_loggedin.php">Or add a new card.</a></p>
<div class="clear"></div>
</div>

<div class="payment_container_bottom"></div><a id="customer_popup_trigger_prod" class="purchase_options_container_continue" href="payment_confirmation_cc_loggedin.php">CONTINUE</a>
